...
export default function DashboardSends({ handleLogSend, isModalOpen}){
    ...
    const searchOptions = ['username', 'boulder', 'grade', 'send_date', 'score'] // Field values for search options
    const [ selectedOption, setSelectedOption] = useState("") // Used for the selected Filter option
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center text-white">
                ...
                {/* <CombinedSelect options={cragOptions}/> */}
           ...
           <div className="grid grid-cols-11 pt-4">
                <div className="col-start-2 grid-span-3 md:col-start-5">
                    <SearchbarSelect searchQuery={searchQuery} onSearchQueryChange={onSearchQueryChange} selectedOption={selectedOption} onSelectChange={onSelectChange} options={searchOptions}/>
                </div>
            </div>
