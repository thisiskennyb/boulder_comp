"""
Django settings for boulder_comp project.
...
MIDDLEWARE = [
    ...
    "boulder_comp.middleware.CorsMiddleware",
]

ROOT_URLCONF = 'boulder_comp.urls'
...
WSGI_APPLICATION = 'boulder_comp.wsgi.application'
